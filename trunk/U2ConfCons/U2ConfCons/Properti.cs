        ...
        public bool checkFile(string filename)
        {
            ...
            if (File.Exists(filename))
            {
                ...
                if (file.Length < 8008064)
                {
                    ...
                    Console.WriteLine("Try to repair bad game file...");
                    if (File.Exists(Directory.GetParent(filename) + "\\GLOBALB.BUN"))
                    {
                        ...
                        {
                            Console.WriteLine("FUCK!!!");
                            Console.WriteLine("Bad game file! Can't install! Check your NFS Underground 2 for GlobalB files!");
                            return false;
                        }
                        else
                        {
                    ...
                    {
                        Console.WriteLine("FUCK!!!");
                        Console.WriteLine("Bad game file! Can't install! Check your NFS Underground 2!");
                        return false;
                    }
                }
                else
